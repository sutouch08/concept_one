    ...
    <p class="pull-right top-p">
      ...
      <?php if($doc->status == 'P' OR $doc->status == 'O') : ?>
        <?php if($this->pm->can_edit) : ?>
          <button type="button" class="btn btn-xs btn-warning" onclick="edit('<?php echo $doc->code; ?>')"><i class="fa fa-pencil"></i> แก้ไข</button>
        <?php endif; ?>
...
<?php endif; ?>
  ...
  <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12 padding-5">
    ...
    <div class="col-lg-4-harf col-md-6-harf col-sm-4 col-xs-6 padding-5">
    ...
    <div class="col-lg-6 col-md-4 col-sm-4-harf col-xs-6 padding-5">
    ...
    <div class="col-lg-12 col-md-10-harf col-sm-7 col-xs-12 padding-5">
  ...
  <div class="col-lg-6 col-md-6 col-sm-6 padding-5">
    <div class="form-horizontal">
      ...
      <div class="form-group">
        ...
        <div class="col-lg-4 col-md-4 col-sm-5 col-xs-6 padding-5 last">
          <input type="text" id="balance-label" class="form-control input-sm text-right" value="<?php echo number($doc->TotalBalance, 2); ?>" disabled/>
        </div>
      </div>
    </div>
  </div>
...
<?php if($doc->status == 'O') : ?>
  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding-5 text-right">
    <button type="button" class="btn btn-sm btn-primary btn-100" id="btn-create-wo" onclick="getSaleOrderDetail()">สร้างใบออเดอร์</button>
    <button type="button" class="btn btn-sm btn-primary btn-100" id="btn-create-wq" onclick="createWQ()">สร้างใบเบิกสินค้า</button>
  </div>
<?php endif; ?>
</div>
<?php if( ! empty($logs)) : ?>
